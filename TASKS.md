...
- [x] **Custom categories must appear in Schedule C breakdown from day one** — when custom categories ship (see P1), `computeScheduleC` must include them, not just `CATEGORIES.find(...)` built-ins. _Guardrails captured in `6a27abe`._
