...
- [architecture.md](architecture.md) — stack, app shell, routing, state/data-fetching conventions, file layout
- [supabase-schema.md](supabase-schema.md) — tables, columns, RLS, edge functions, what's NOT in this repo
- [categories.md](categories.md) — the 21 Schedule C categories, tax flags (`isExcluded`, `mealsHalf`), known correctness gaps
- [data-flows.md](data-flows.md) — cross-cutting business logic: record/edit/delete sale, FIFO COGS, transaction exclusion rules used by every total on the Dashboard
- features/
