...
import { createItem, createLot, deleteLot, fetchLotsForTransaction } from '../lib/mutations'
...
export default function TransactionInventorySection({ transactionId, transactionTotal }: Props) {
  ...
  function resetForm() {
    ...
    setNewItemName(''); setNewItemCategory(''); setQuantity('1'); setUnitCost(''); setError(null)
  }
